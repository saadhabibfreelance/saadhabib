...
export const CTA = memo(function CTA() {
  return (
    <Section index={6} id="contact">
      <div
        data-reveal="scale"
        className="mx-auto max-w-4xl rounded-[2.5rem] bg-[#1A1A2E] px-6 py-16 text-center text-white shadow-2xl sm:px-12"
      >
        ...
        <div data-reveal="fade" data-reveal-delay="0.3" className="mt-10 flex flex-wrap justify-center gap-4">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-[#FFEE00] px-7 py-4 text-base font-bold text-[#1A1A2E] shadow-lg transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-1"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border-2 border-white/50 px-7 py-4 text-base font-bold text-white transition-colors duration-300 hover:bg-white hover:text-[#1A1A2E]"
          >
