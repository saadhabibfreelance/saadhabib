...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Saad Habib — Freelance Data, Leads & E-commerce" },
      { name: "twitter:description", content: "Cinematic freelance studio by Saad Habib: data entry, lead generation, email marketing, and e-commerce store design that ships fast." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/de45c1d7-99df-425e-9f5d-a5ae890de328" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/de45c1d7-99df-425e-9f5d-a5ae890de328" },
    ],
    links: [
