    ...
    <main className="pt-24 text-white">
      <section className="px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="mx-auto max-w-4xl text-center">
          <h1 data-reveal="split" className="text-4xl font-bold tracking-tight text-white sm:text-5xl">About us</h1>
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-12 md:grid-cols-2">
            {/* Saad Habib */}
            <div data-reveal="scale" className="rounded-2xl border border-white/15 bg-white/[0.06] backdrop-blur-xl p-8 text-center shadow-sm transition-all duration-500 hover:-translate-y-2 hover:border-gold hover:shadow-[0_25px_50px_-15px_rgba(0,0,0,0.25)]">
              ...
              <h2 className="mt-6 text-2xl font-bold text-white">Saad Habib</h2>
              <p className="mt-1 text-sm font-medium text-white/70">Founder</p>
              ...
              <a
                ...
                className="mt-5 inline-flex h-10 w-10 items-center justify-center rounded-full bg-navy text-cream transition-colors hover:bg-gold hover:text-white"
              >
            ...
            {/* Misbah */}
            <div data-reveal="scale" data-reveal-delay="0.12" className="rounded-2xl border border-white/15 bg-white/[0.06] backdrop-blur-xl p-8 text-center shadow-sm transition-all duration-500 hover:-translate-y-2 hover:border-gold hover:shadow-[0_25px_50px_-15px_rgba(0,0,0,0.25)]">
              <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-gold text-3xl font-bold text-white">
                M
              </div>
              <h2 className="mt-6 text-2xl font-bold text-white">Misbah</h2>
              <p className="mt-1 text-sm font-medium text-white/70">Founder</p>
              <p className="mt-4 text-white/70">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2">
            <a
              ...
              className="flex items-center gap-4 rounded-xl border border-white/15 bg-white/[0.06] backdrop-blur-xl p-6 shadow-sm transition-colors hover:bg-muted"
            >
